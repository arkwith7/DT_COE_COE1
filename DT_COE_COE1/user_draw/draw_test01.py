...
def read_image(img_for_box_extraction_path, checking):
    if checking == True:
...
if __name__ == '__main__':
    # 이미지 읽어 온다
    img, img_bin = read_image("../img/cigar/20191024_190659.jpg", True)  # Read the image
    origin_img = img
    ...
    img, img_bin = read_image(dst, False)
